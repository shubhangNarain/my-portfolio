  ...
  return (
    <div className='flex items-center justify-between'>
      ...
      <div className='p-5 lg:p-10'>
        <Link class="bg-transparent hover:bg-gradient-to-r from-pink-300 via-purple-300 to-indigo-400 hover:text-black text-whiet-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow"
